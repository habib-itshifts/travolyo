        ...
        <div class="card-body p-4">
            <div class="d-flex align-items-center gap-4">
                <div class="rounded-circle d-flex align-items-center justify-content-center text-white fw-bold flex-shrink-0"
                     style="width:72px;height:72px;font-size:1.6rem;background:linear-gradient(135deg,#0f1f38,#3ab5d4);">
                    {{ strtoupper(substr($user->first_name, 0, 1)) }}{{ strtoupper(substr($user->last_name ?? '', 0, 1)) }}
                </div>
                <div>
                    <h5 class="fw-bold mb-0">{{ $user->name }}</h5>
                    <p class="text-muted small mb-1">{{ $user->email }}</p>
                    <span class="badge rounded-pill" style="background:rgba(58,181,212,0.12);color:#0f6fad;font-size:11px;">
                        Administrator
                    </span>
                </div>
            </div>
                    ...
                    <form method="POST" action="{{ route('admin.profile.update') }}">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="submit" class="btn btn-sm fw-semibold text-white px-4"
                                    style="background:linear-gradient(135deg,#0f6fad,#3ab5d4);border:none;border-radius:8px;">
                                Save Changes
                            </button>
                        </div>
                    </form>
        ...
        <div class="tab-pane fade" id="business">
            <div class="card border rounded-4 shadow-sm" style="border-color:rgba(0,0,0,0.06)!important;">
                <div class="card-body p-4" style="max-width:600px;">
                    ...
                    <p class="text-muted small mb-4">Optional business details for this admin account.</p>
                    ...
                    <form method="POST" action="{{ route('admin.profile.update') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="business_name" class="form-control rounded-3"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tax_number" class="form-control rounded-3"
