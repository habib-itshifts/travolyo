<x-admin::layouts.master title="Edit Deal - {{ $hotel->name }}">
    ...
    <form method="POST" action="{{ route('admin.hotels.deals.update', [$hotel, $deal]) }}">@csrf @method('PUT') @include('admin::hotel-deals._form', ['isVendor' => false])
