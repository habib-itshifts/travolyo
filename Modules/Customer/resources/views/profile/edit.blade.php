<x-customer::layouts.master>
            ...
            <div class="d-flex align-items-center gap-4">
                <div class="position-relative flex-shrink-0">
                    <div class="rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                         style="width:72px;height:72px;font-size:1.6rem;background:linear-gradient(135deg,#312e81,#6366f1);">
                ...
                <div>
                    ...
                    <span class="badge rounded-pill" style="background:rgba(99,102,241,0.12);color:#4f46e5;font-size:11px;">
                        Customer
                    </span>
                </div>
            </div>
    ...
    <ul class="nav nav-tabs border-bottom mb-4" id="profileTabs">
        <li class="nav-item">
            <a class="nav-link active fw-semibold" href="#personal" data-bs-toggle="tab" style="font-size:13px;">
                Personal Info
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link fw-semibold" href="#contact" data-bs-toggle="tab" style="font-size:13px;">
                Contact & Address
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link fw-semibold" href="#security" data-bs-toggle="tab" style="font-size:13px;">
                Security
            </a>
        </li>
    </ul>
                    ...
                    <form method="POST" action="{{ route('customer.profile.update') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="birthday" class="form-control rounded-3 @error('birthday') is-invalid @enderror"
                                       value="{{ old('birthday', $user->birthday?->format('Y-m-d')) }}">
                                @error('birthday') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold small">Nationality</label>
                                <input type="text" name="nationality" class="form-control rounded-3 @error('nationality') is-invalid @enderror"
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="submit" class="btn btn-sm fw-semibold text-white px-4"
                                    style="background:linear-gradient(135deg,#4f46e5,#6366f1);border:none;border-radius:8px;">
                                Save Changes
                            </button>
                        </div>
                    </form>
            ...
            <div class="card border rounded-4 shadow-sm" style="border-color:rgba(0,0,0,0.06)!important;">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('customer.profile.update') }}">
                        ...
                        {{-- carry over personal fields so they don't get wiped --}}
