...
<div class="row g-4">
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm rounded-3">
            ...
            <div class="card-body">
                <div class="mb-3"><label class="form-label fw-semibold">Valid From</label><input type="date" name="valid_from" value="{{ old('valid_from', $pc?->valid_from?->format('Y-m-d')) }}" class="form-control"></div>
                <div class="mb-3"><label class="form-label fw-semibold">Valid Until</label><input type="date" name="valid_until" value="{{ old('valid_until', $pc?->valid_until?->format('Y-m-d')) }}" class="form-control"></div>
            </div>
        </div>
        <div class="card border-0 shadow-sm rounded-3 mt-4">
            <div class="card-body">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="is_active" value="1" id="is_active" {{ old('is_active', $pc?->is_active ?? true) ? 'checked' : '' }}>
