<x-vendor::layouts.master title="Promo Codes">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <p class="text-muted mb-0" style="font-size:13px;">Manage your promotional codes</p>
        </div>
        <a href="{{ route('vendor.promo-codes.create') }}" class="btn btn-sm text-white d-inline-flex align-items-center gap-2"
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <div class="d-flex justify-content-end gap-1">
                                        <a href="{{ route('vendor.promo-codes.edit', $promo->id) }}"
                                           class="btn btn-sm btn-outline-primary" title="Edit">
                                            <svg width="13" height="13" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                        </a>
                                        <form method="POST" action="{{ route('vendor.promo-codes.destroy', $promo->id) }}"
