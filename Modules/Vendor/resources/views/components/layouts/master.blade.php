...
<head>
    ...
    {{-- Vendor colour tokens --}}
    <style>
        :root {
            --clr-primary:          #16a34a;
            --clr-primary-dark:     #15803d;
            --clr-primary-light:    rgba(22, 163, 74, 0.15);
            --clr-sidebar-bg:       #0d2818;
            --clr-sidebar-hover:    rgba(255, 255, 255, 0.06);
            --clr-sidebar-active:   rgba(22, 163, 74, 0.15);
            --clr-sidebar-text:     #7a9e87;
            --clr-sidebar-text-act: #16a34a;
            --clr-sidebar-section:  #3d6b4a;
            --clr-sidebar-icon:     #2a5235;
            --clr-sidebar-disabled: #1a3d28;
            --clr-page-bg:          #f4f7f5;
...
<div class="d-flex" style="min-height:100vh;">
    ...
    <aside class="sidebar-bg d-flex flex-column flex-shrink-0" style="width: var(--sidebar-width); min-height: 100vh;">
        ...
        <div class="d-flex align-items-center gap-2 px-3 border-bottom border-white border-opacity-10" style="padding-top:18px;padding-bottom:18px;">
            <a href="{{ route('vendor.dashboard') }}" class="d-flex align-items-center gap-2 text-decoration-none">
                ...
                <span class="badge-version">Vendor</span>
            </a>
        </div>
        ...
        <div class="px-3 py-3 border-top border-white border-opacity-10">
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="flex-fill" style="min-width:0;">
                    ...
                    <p class="mb-0 text-truncate" style="color:var(--clr-sidebar-section);font-size:11px;">Vendor</p>
                </div>
