<x-vendor::layouts.master title="Space Details">
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('vendor.spaces.availability', $space->id) }}" class="btn btn-sm btn-outline-dark">Manage Availability</a>
            <a href="{{ route('vendor.spaces.edit', $space->id) }}" class="btn btn-sm text-white" style="background:var(--clr-primary);">Edit Space</a>
        </div>
    </div>
