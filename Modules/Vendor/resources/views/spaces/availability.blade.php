<x-vendor::layouts.master title="Manage Availability">
        ...
        <div>
            <nav aria-label="breadcrumb" style="font-size:12px;">
                <ol class="breadcrumb mb-1">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('vendor.spaces.show', $space->id) }}" class="text-decoration-none">{{ $space->name }}</a></li>
    ...
    <div class="card border-0 shadow-sm rounded-3 mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('vendor.spaces.availability.update', $space->id) }}">
                @csrf
                <div class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3">
                        <label class="form-label fw-semibold" style="font-size:13px;">Price Override</label>
    ...
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header bg-white border-bottom">
            <h6 class="fw-bold mb-0">Current Availability</h6>
        </div>
        <div class="card-body p-0">
            @if ($availabilities->isEmpty())
                <div class="text-center text-muted py-5">
                    <p class="mb-0">No availability overrides. All dates default to available at the base price.</p>
                </div>
            @else
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderDates() {
                ...
                Array.from(dates).sort().forEach(date => {
                    ...
                    badge.innerHTML = `<input type="hidden" name="dates[]" value="${date}">${date}<button type="button" class="btn-close" style="font-size:8px;"></button>`;
