<x-vendor::layouts.master title="Room Types">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h5 class="fw-bold mb-0 text-dark">Room Types</h5>
            <p class="text-muted mb-0" style="font-size:13px;">Manage your room type templates</p>
        </div>
        <a href="{{ route('vendor.room-types.create') }}" class="btn btn-sm text-white d-inline-flex align-items-center gap-2"
    ...
    <div class="card border-0 shadow-sm rounded-3 mb-4">
        <div class="card-body py-3">
            <form method="GET" action="{{ route('vendor.room-types.index') }}">
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-md-3 d-flex gap-2">
                        ...
                        <a href="{{ route('vendor.room-types.index') }}" class="btn btn-sm btn-outline-secondary px-3">Reset</a>
                    </div>
                </div>
            </form>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0 align-middle" style="font-size:13px;">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <div class="d-flex justify-content-end gap-1">
                                        <a href="{{ route('vendor.room-types.edit', $rt) }}" class="btn btn-sm btn-outline-primary" title="Edit">
                                            <svg width="13" height="13" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                        </a>
                                        <form method="POST" action="{{ route('vendor.room-types.destroy', $rt) }}" onsubmit="return confirm('Delete this room type?')">
                                            @csrf @method('DELETE')
                        ...
                        @empty
                            <tr><td colspan="6" class="text-center text-muted py-5">No room types found.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
