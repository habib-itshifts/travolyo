...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control bg-light" value="{{ ucfirst($deal?->status ?? 'draft') }}" disabled>
        <small class="text-muted">Vendor deals are submitted as draft — admin must approve.</small>
    </div>
    <div class="col-md-6">
